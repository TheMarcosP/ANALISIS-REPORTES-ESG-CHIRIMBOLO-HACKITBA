...
def extract_text_from_pdf(pdf_file_path):
    ...
    Notes:
        ...
        - The function polls the job status every 40 seconds until the job is completed.
    """
    ...
    # Handle pagination to retrieve all pages
    extracted_text = ''
    next_token = None
    ...
    while True:
        ...
        next_token = result.get('NextToken')  # Check if there's more data
        if not next_token:
            break  # Exit loop when no more pages remain
